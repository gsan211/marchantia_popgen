...
def download_from_url(url, timeout=12000, retry=0, min_file_bytes=20, url_to_validate={}):
    """
...
def retry_from_failed(login_cmd, fail_log, timeout=12000, retries=3):
    """
...
def download_list(url_list, url_to_validate={}, timeout=12000, retries=3):
    """
